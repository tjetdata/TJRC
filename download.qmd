...
Below are the replication data for our most recent publications. They do not include the full spectrum of data availalbe to browse or query, but they are tailored to specific research questions that we have. If you would like data to answer a specific research question, email Geoff Dancy at **[geoff.dancy@utoronto.ca](mailto:geoff.dancy@utoronto.ca)** for more information.

Dancy, Geoff, Bridget Marchesi, Tricia Olsen, Leigh A. Payne, Andrew Reiter, and Kathryn Sikkink. 2019. "Behind Bars and Bargains: New Findings on Transitional Justice in Emerging Democracies" Forthcoming, *International Studies Quarterly*.

\[[Data](files/barsbargains.dta)\] \[[Figure 1 Data](files/barsbargains_fig1.dta)\] \[[STATA do file](files/BarsBargains4.1_replicate.do)\] \[[Replication memo](files/ReplicationMemo.rtf)\]
...
Democratic Transitions, 1970-2010: [pdf](files/DemoTransitions.pdf)

Domestic Criminal Prosecutions Coding Manual: [pdf](files/TrialsCodingManual.pdf)

Amnesty Coding Manual: [pdf](files/AmnestyCodingManual.pdf)

Truth Commission Coding Manual: [pdf](files/TruthCommissionCodingManual.pdf)

## Feedback and Corrections

The Collaborative welcomes and encourages [Feedback](feedback.html) from country experts. With such feedback, we hope to continue to improve the currently available data. We will review your comments, research them, verify them, and make emendations if necessary.
